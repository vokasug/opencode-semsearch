...
За один вызов догоняется не более `SEMSEARCH_LAZY_MAX` сообщений (default 300) — чтобы большой бэклог не упирался в таймаут тула. Остаток доиндексируется следующими вызовами, либо сразу: `oc-semsearch build`.
...
| `SEMSEARCH_LAZY_MAX` | 300 | Максимум эмбеддингов догонки за один вызов |
